...
FORMATS_BY_TYPE: dict[DeliverableType, list[str]] = {
    DeliverableType.executive_summary: ["pptx", "docx", "md"],
    DeliverableType.current_state_assessment: ["docx", "md"],
    DeliverableType.opportunity_register: ["xlsx", "docx", "md"],
    DeliverableType.roadmap_deck: ["pptx", "md"],
}
